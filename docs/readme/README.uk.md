...
`v1.4.0` випущено. Реалізовано список пресетів, деталі, ручне копіювання, optional root і optional overlay, а інтерфейс перекладено **20 мовами** з вбудованим перемиканням мови (значок перекладу на панелі інструментів відкриває меню мов). MIT, FOSS, без GMS.
